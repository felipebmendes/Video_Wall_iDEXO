var Week_Calendar = SuperWidget.extend({
    ...
    init: function() {
    	...
    	dadosSeg.sort(compare);
    	dadosTer.sort(compare);
    	dadosQua.sort(compare);
    	dadosQui.sort(compare);
    	dadosSex.sort(compare);
    	...
    	if(dadosSeg.length == 0){
    		...
    		for(i = dadosSeg.length - 1; i >= 0 ; i--){
    			dados += '<p class="tituloEvento">' + dadosSeg[i].startHour + " - " + dadosSeg[i].endHour + '</p><p class="tituloEvento">' + dadosSeg[i].event + "</p>";
    		}
    		dados += "</div>";
    	...
    	if(dadosTer.length == 0){
    		...
    		for(i = dadosTer.length - 1; i >= 0 ; i--){
    			dados += '<p class="tituloHorario">' + dadosTer[i].startHour + " - " + dadosTer[i].endHour + '</p><p class="tituloEvento">' + dadosTer[i].event + "</p>";
    		}
    		dados += "</div>";
    	...
    	if(dadosQua.length == 0){
    		...
    		for(i = dadosQua.length - 1; i >= 0 ; i--){
    			dados += '<p class="tituloHorario">' + dadosQua[i].startHour + " - " + dadosQua[i].endHour + '</p><p class="tituloEvento">' + dadosQua[i].event + "</p>";
    		}
    		dados += "</div>";
    	...
    	if(dadosQui.length == 0){
    		...
    		for(i = dadosQui.length - 1; i >= 0 ; i--){
    			dados += '<p class="tituloHorario">' + dadosQui[i].startHour + " - " + dadosQui[i].endHour + '</p><p class="tituloEvento">' + dadosQui[i].event + "</p>";
    		}
    		dados += "</div>";
    	...
    	if(dadosSex.length == 0){
    		...
    		for(i = dadosSex.length - 1; i >= 0 ; i--){
    			dados += '<p class="tituloHorario">' + dadosSex[i].startHour + " - " + dadosSex[i].endHour + '</p><p class="tituloEvento">' + dadosSex[i].event + "</p>";
    		}
    		dados += "</div>";
...
function abreModal(dados){
	document.getElementById("modalTitulo").innerHTML = dados.event;
